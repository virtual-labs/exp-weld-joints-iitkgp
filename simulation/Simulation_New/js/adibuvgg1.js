...
stldr.load(tr, function ( trn ) {
	...
	scn.add( trnme );
    trnme.rotation.set( Math.PI/12, -Math.PI/6.8, Math.PI/1.85 );
    trnme.position.set(-sizs.wd / sizs.ht*0.08, sizs.wd / sizs.ht*0.4, sizs.wd / sizs.ht*0.14);
...
wrv.position.set(-sizs.wd / sizs.ht*0.49, sizs.wd / sizs.ht*0.25, sizs.wd / sizs.ht*0.71);
...
fill.position.set(-sizs.wd / sizs.ht*0.401, -sizs.wd / sizs.ht*0.005, sizs.wd / sizs.ht*0.688);
...
const bsmtlbl = setInterval(() => {
    ...
    bslbl=lbar[0];
    if (lbar[0] &&  lbar[1]) {
        const upOffset = new THREE.Vector3(-(sizs.wd / sizs.ht) *0.5, (sizs.wd / sizs.ht) * 0.32, (sizs.wd / sizs.ht) *0.25);
...
const eclbl = setInterval(() => {
    ...
    ecblarw=lbar[1];
    if (lbar[0] &&  lbar[1]) {
        let upOffset = new THREE.Vector3(-(sizs.wd / sizs.ht)*0.11, (sizs.wd / sizs.ht) * 0.3, (sizs.wd / sizs.ht)*0.15);
        ecblof=upOffset;
...
const loop = () => {
    ...
    if(i<= ((sizs.wd / sizs.ht)*0.525)){
        adit();
        trnme.position.set(-sizs.wd / sizs.ht*0.08+k, trnme.position.y, sizs.wd / sizs.ht*0.14-m);
        ...
        wrv.position.y -=sizs.wd / sizs.ht*0.00005;
        ...
        rndr.render(scn,cam);
            ...
            if(adi==0){
                ...
                scn.add( trnme );
                trnme.rotation.set( Math.PI/12, -Math.PI/6.8, Math.PI/1.85 );
                trnme.position.set(-sizs.wd / sizs.ht*0.08+1.1*k, sizs.wd / sizs.ht*0.4, sizs.wd / sizs.ht*0.14-1.1*m);
                trnme.scale.set(l*3.0,b*3.0,h*3.0 );
                trnme.castShadow = true;
                trnme.receiveShadow = true;
