...
stldr.load(ml, function ( mld ) {
	...
	scn.add( mldme );
    mldme.rotation.set( Math.PI / 2, Math.PI / 2, Math.PI/1.2*0 );
...
stldr.load(tr, function ( trn ) {
	...
	scn.add( trnme );
    trnme.rotation.set( Math.PI, Math.PI, Math.PI );
    trnme.position.set(sizs.wd / sizs.ht*0.2, -sizs.wd / sizs.ht*0.03, sizs.wd / sizs.ht*0.115);
...
wrv.rotation.set( Math.PI/8*0, Math.PI/12*0, -Math.PI/3*1);
wrv.position.set(sizs.wd / sizs.ht*0.23, sizs.wd / sizs.ht*0.12, sizs.wd / sizs.ht*0.79);
...
fill.rotation.set( Math.PI/2*0, -Math.PI/2*0, -Math.PI/2);
fill.position.set(-sizs.wd / sizs.ht*0.00, sizs.wd / sizs.ht*0.005, sizs.wd / sizs.ht*0.798);
...
const bsmtlbl = setInterval(() => {
    ...
    bslbl=lbar[0];
    if (lbar[0] &&  lbar[1]) {
        const upOffset = new THREE.Vector3((sizs.wd / sizs.ht) *0.05, (sizs.wd / sizs.ht) * 0.85, (sizs.wd / sizs.ht) *0.05);
        ...
        lbar[1].setLength(length*0.41, (sizs.wd / sizs.ht) * 0.03, (sizs.wd / sizs.ht) * 0.02);
    }
}, 100);
...
const eclbl = setInterval(() => {
    ...
    ecblarw=lbar[1];
    if (lbar[0] &&  lbar[1]) {
        let upOffset = new THREE.Vector3((sizs.wd / sizs.ht)*0.08, (sizs.wd / sizs.ht) * 0.25, -(sizs.wd / sizs.ht)*0.00);
        ecblof=upOffset;
...
const loop = () => {
    ...
    window.requestAnimationFrame(loop);
     ...
     if(i<= ((sizs.wd / sizs.ht)*0.585)){
        adit();
        trnme.position.set(sizs.wd / sizs.ht*0.2, -sizs.wd / sizs.ht*0.03, sizs.wd / sizs.ht*0.115-m);
        ...
        wrv.position.x -=sizs.wd / sizs.ht*0.000005;
        wrv.position.y -=sizs.wd / sizs.ht*0.000055;
        ...
        rndr.render(scn,cam);
            ...
            if(adi==0){
                ...
                scn.add( trnme );
                trnme.rotation.set( Math.PI, Math.PI, Math.PI );
                trnme.position.set(sizs.wd / sizs.ht*0.2, -sizs.wd / sizs.ht*0.03, sizs.wd / sizs.ht*0.115-m-0.15);
                trnme.scale.set(l*3.0,b*3.0,h*3.0 );
                trnme.castShadow = true;
                trnme.receiveShadow = true;
                    lblupd(trnme,ecblsprt,ecblarw,ecblof); 
