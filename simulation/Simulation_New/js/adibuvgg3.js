...
stldr.load(ml, function ( mld ) {
	...
	scn.add( mldme );
    mldme.rotation.set( -Math.PI / 2*0, Math.PI / 2, Math.PI/1.2*0 );
...
stldr.load(tr, function ( trn ) {
	...
	scn.add( trnme );
    trnme.rotation.set( Math.PI/2, Math.PI, Math.PI );
    trnme.position.set(sizs.wd / sizs.ht*0.23, sizs.wd / sizs.ht*0.14, sizs.wd / sizs.ht*0.03);
...
wrv.rotation.set( Math.PI/8*1, Math.PI/12*1, Math.PI/8*1);
wrv.position.set(sizs.wd / sizs.ht*0.15, sizs.wd / sizs.ht*0.64, -sizs.wd / sizs.ht*0.1);
...
fill.rotation.set( Math.PI/2, -Math.PI/2*0, -Math.PI/2);
fill.position.set(-sizs.wd / sizs.ht*0.010, sizs.wd / sizs.ht*0.80, -sizs.wd / sizs.ht*0.0);
...
const bsmtlbl = setInterval(() => {
    ...
    bslbl=lbar[0];
    if (lbar[0] &&  lbar[1]) {
        const upOffset = new THREE.Vector3((sizs.wd / sizs.ht) *0.05, (sizs.wd / sizs.ht) * 0.99, -(sizs.wd / sizs.ht) *0.35);
...
const eclbl = setInterval(() => {
    ...
    ecblarw=lbar[1];
    if (lbar[0] &&  lbar[1]) {
        let upOffset = new THREE.Vector3((sizs.wd / sizs.ht)*0.05, (sizs.wd / sizs.ht) * 0.95, -(sizs.wd / sizs.ht)*0.033);
        ecblof=upOffset;
        ...
        lbar[1].position.copy(labelPos);
        lbar[1].setDirection(dir);
        lbar[1].setLength(length*0.28, (sizs.wd / sizs.ht) * 0.03, (sizs.wd / sizs.ht) * 0.02);
    }}
}, 10);
...
const loop = () => {
    ...
    window.requestAnimationFrame(loop);
       ...
       if(i<= ((sizs.wd / sizs.ht)*0.585)){
        adit();
        trnme.position.set(sizs.wd / sizs.ht*0.23, sizs.wd / sizs.ht*0.14-m, sizs.wd / sizs.ht*0.03);
        ...
        wrv.position.x -=sizs.wd / sizs.ht*0.00010;
        wrv.position.y -=sizs.wd / sizs.ht*0.0018;
        wrv.position.z +=sizs.wd / sizs.ht*0.000055;
        ...
        rndr.render(scn,cam);
            ...
            if(adi==0){
                ...
                scn.add( trnme );
                trnme.rotation.set( Math.PI/2, Math.PI, Math.PI );
                trnme.position.set(sizs.wd / sizs.ht*0.23, sizs.wd / sizs.ht*0.14-m-0.15, sizs.wd / sizs.ht*0.03);
                trnme.scale.set(l*3.0,b*3.0,h*3.0 );
                trnme.castShadow = true;
                trnme.receiveShadow = true;
                    lblupd(trnme,ecblsprt,ecblarw,ecblof); 
