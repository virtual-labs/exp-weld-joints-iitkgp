...
stldr.load(ar, function ( arn ) {
	...
	scn.add( arnme );
    arnme.rotation.set( -Math.PI/2, Math.PI/2*0, Math.PI/2*0 );
    arnme.position.set(-sizs.wd / sizs.ht*0.00, sizs.wd / sizs.ht*0.17, sizs.wd / sizs.ht*0.395);
...
fill.position.set(sizs.wd / sizs.ht*0.00, -sizs.wd / sizs.ht*0.005, sizs.wd / sizs.ht*0.4);
...
filc.rotation.set( Math.PI/1*0, -Math.PI/6*0, -Math.PI/2*0);
...
const loop = () => {
    ...
    if(i<= ((sizs.wd / sizs.ht)*0.525)){
       ...
       arnme.position.set(-sizs.wd / sizs.ht*0.00, sizs.wd / sizs.ht*0.17, sizs.wd / sizs.ht*0.395-m);
