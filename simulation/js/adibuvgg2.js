...
stldr.load(ml, function ( mld ) {
    ...
    mldme.rotation.set( -Math.PI / 2, Math.PI / 2, Math.PI/2*0 );
...
stldr.load(tr, function ( trn ) {
	...
	scn.add( trnme );
    trnme.rotation.set( -Math.PI/2, +Math.PI/2*0, -Math.PI );
    trnme.position.set(sizs.wd / sizs.ht*0.4, sizs.wd / sizs.ht*0.0, sizs.wd / sizs.ht*0.4);
...
stldr.load(ar, function ( arn ) {
	...
	scn.add( arnme );
    arnme.rotation.set( -Math.PI/2, Math.PI/2, Math.PI/2*0 );
    arnme.position.set(sizs.wd / sizs.ht*0.15, sizs.wd / sizs.ht*0.0, sizs.wd / sizs.ht*0.395);
...
fill.position.set(-sizs.wd / sizs.ht*0, -sizs.wd / sizs.ht*0.000, sizs.wd / sizs.ht*0.4);
...
const bsmtlbl = setInterval(() => {
    ...
    bslbl=lbar[0];
    if (lbar[0] &&  lbar[1]) {
        const upOffset = new THREE.Vector3((sizs.wd / sizs.ht) *0.05, (sizs.wd / sizs.ht) * 0.78, (sizs.wd / sizs.ht) *0.15);
...
const eclbl = setInterval(() => {
    ...
    ecblarw=lbar[1];
    if (lbar[0] &&  lbar[1]) {
        let upOffset = new THREE.Vector3((sizs.wd / sizs.ht)*0.39, (sizs.wd / sizs.ht) * 0.38, -(sizs.wd / sizs.ht)*0.25);
        ecblof=upOffset;
...
const loop = () => {
    ...
    if(i<= ((sizs.wd / sizs.ht)*0.525)){
        ...
        trnme.position.set(sizs.wd / sizs.ht*0.4, sizs.wd / sizs.ht*0.0, sizs.wd / sizs.ht*0.4-m);
        arnme.position.set(sizs.wd / sizs.ht*0.15, sizs.wd / sizs.ht*0.0, sizs.wd / sizs.ht*0.395-m);
