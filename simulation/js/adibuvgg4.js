...
stldr.load(ml, function ( mld ) {
    ...
    mldme.rotation.set( Math.PI /2, 0, Math.PI/2*0 );
...
stldr.load(ar, function ( arn ) {
	...
	scn.add( arnme );
    arnme.rotation.set( Math.PI/2*1, Math.PI/2*0, Math.PI/2*0 );
    arnme.position.set(-sizs.wd / sizs.ht*0.00, -sizs.wd / sizs.ht*0.15, sizs.wd / sizs.ht*0.395);
...
fill.position.set(-sizs.wd / sizs.ht*0, -sizs.wd / sizs.ht*0.005, sizs.wd / sizs.ht*0.4);
fill.rotation.set( Math.PI/1*1, -Math.PI/6*0, -Math.PI/2*0);
...
filc.position.set(sizs.wd / sizs.ht*0.00, -sizs.wd / sizs.ht*0.099, sizs.wd / sizs.ht*0.4);
filc.rotation.set( Math.PI/1*1, -Math.PI/6*0, -Math.PI/2*0);
...
const bsmtlbl = setInterval(() => {
    ...
    bslbl=lbar[0];
    if (lbar[0] &&  lbar[1]) {
        const upOffset = new THREE.Vector3(-(sizs.wd / sizs.ht) *0.3, -(sizs.wd / sizs.ht) * 0.23, (sizs.wd / sizs.ht) *0.15);
        ...
        lbar[1].setLength(length*0.55, (sizs.wd / sizs.ht) * 0.03, (sizs.wd / sizs.ht) * 0.02);
    }
}, 100);
...
const eclbl = setInterval(() => {
    ...
    ecblarw=lbar[1];
    if (lbar[0] &&  lbar[1]) {
        let upOffset = new THREE.Vector3(-(sizs.wd / sizs.ht)*0.0, -(sizs.wd / sizs.ht) * 0.5, (sizs.wd / sizs.ht)*0.0);
        ecblof=upOffset;
...
const loop = () => {
 ...
 if(i==0){
    ...
    if(i<= ((sizs.wd / sizs.ht)*0.525)){
        trnme.position.set(-sizs.wd / sizs.ht*0.0, -sizs.wd / sizs.ht*0.4, sizs.wd / sizs.ht*0.4-m);
        arnme.position.set(-sizs.wd / sizs.ht*0.00, -sizs.wd / sizs.ht*0.15, sizs.wd / sizs.ht*0.395-m);
        lblupd(trnme,ecblsprt,ecblarw,ecblof);

        rndr.render(scn,cam);
        k+=sizs.wd / sizs.ht*0.0011;
        m+=sizs.wd / sizs.ht*0.00225;    
        ...
        adit(0);
            if(adi==0){
                ...
                scn.add( mldme );
                mldme.rotation.set( Math.PI /2, 0, Math.PI/2*0 );
                mldme.position.set( -sizs.wd / sizs.ht*0.0 , -sizs.wd / sizs.ht*0.0, -sizs.wd / sizs.ht*0.4 );
                mldme.scale.set(sizs.wd / sizs.ht*0.01 , sizs.wd / sizs.ht*0.01, sizs.wd / sizs.ht*0.01 );
                mldme.castShadow = true;
                mldme.receiveShadow = true;
